...
* **share.js:** Handle DID URI input ([9cbb02a](https://github.com/AraBlocks/ara-identity/commit/9cbb02a))


### Features

* **archive.js:** Allow for local archives (no network) ([61cc00d](https://github.com/AraBlocks/ara-identity/commit/61cc00d))
* **bin/aid:** Introduce 'aid share' ([eda7cbc](https://github.com/AraBlocks/ara-identity/commit/eda7cbc))
* **share.js:** Introduce 'aid.share()' ([1500115](https://github.com/AraBlocks/ara-identity/commit/1500115))
...
* **bin/aid:** Introduce 'bind-dns' and 'unbind-dns' command ([5a339f6](https://github.com/AraBlocks/ara-identity/commit/5a339f6))
* **dns.js:** Add 'dns.bind()' and 'dns.unbind()' ([5572b54](https://github.com/AraBlocks/ara-identity/commit/5572b54))
...
* **bin/aid:** Fix password input from stdin ([f0ae0bd](https://github.com/AraBlocks/ara-identity/commit/f0ae0bd))
* **scripts/package.sh:** Fix 'pkg' npm script ([3ae3e65](https://github.com/AraBlocks/ara-identity/commit/3ae3e65))
...
* **dns:** Initial DNS module ([7a0a9e9](https://github.com/AraBlocks/ara-identity/commit/7a0a9e9))
* **whoami:** Make 'whoami' a module level funcion ([c83eaa9](https://github.com/AraBlocks/ara-identity/commit/c83eaa9))
...
* **package.json:** Hardcode web3 to beta.37 bc later versions borked ([a1cf33a](https://github.com/AraBlocks/ara-identity/commit/a1cf33a))
...
* **archive.js:** Handle errors throw on 'Handshake' instance ([488116b](https://github.com/AraBlocks/ara-identity/commit/488116b))
...
* **bin/aid:** Introduce 'aid export-public-key' ([900e34a](https://github.com/AraBlocks/ara-identity/commit/900e34a))
